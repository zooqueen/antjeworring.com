    ...
    <div id="main">
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6rem', alignItems: 'center' }} className="story-grid">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
              <div style={{ position: 'relative', aspectRatio: '3/4', overflow: 'hidden', borderRadius: '1.5rem', boxShadow: '0 10px 40px rgba(0,0,0,0.1)', width: '45%', flexShrink: 0 }}>
      ...
      <section style={{ background: 'var(--color-cream)', width: '100%' }}>
        <div style={{ width: '100%', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', borderTop: '1px solid #000' }}>
          {[3, 8, 2, 5, 6, 7, 4, 9, 11, 13, 14, 15].map((num, index) => (
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6rem', alignItems: 'center' }} className="story-grid">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} style={{ position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: '-15%', left: '0%', width: '55%', aspectRatio: '1/1', overflow: 'hidden', borderRadius: '1rem', boxShadow: '0 10px 30px rgba(0,0,0,0.25)' }}>
        ...
        <div className="container" style={{ marginBottom: '3rem', position: 'relative', zIndex: 2 }}>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p style={{ fontSize: '1.4rem', color: '#fff', opacity: 0.8, textAlign: 'center', marginBottom: '1rem' }}>
              Educational NFT Game from 2021
            </p>
